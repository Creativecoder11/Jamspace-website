...
const ArrowRight = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clipPath="url(#clip0_734_7039)"><g clipPath="url(#clip1_734_7039)">
        ...
        <defs><clipPath id="clip0_734_7039"><rect width="24" height="24" fill="white" /></clipPath><clipPath id="clip1_734_7039"><rect width="24" height="24" fill="white" transform="matrix(1 2.62268e-07 2.62268e-07 -1 4.19629e-06 24)" /></clipPath></defs>
    </svg>
);

export default function ProjectsChallenges({ project }: { project: Project }) {
    return (
            ...
            <div className="mx-auto w-full max-w-335">
                <div className="flex flex-col md:flex-row gap-10 md:gap-12">
                    <div className="relative w-full aspect-430/545 md:aspect-auto md:w-[430px] md:h-[545px] shrink-0 overflow-hidden">
                        <Image src={project.challengesMainImage} alt="Poolside terrace interior" fill sizes="(min-width: 768px) 430px, 100vw" className="object-cover" />
                    </div>
                    <div className="flex-1 flex flex-col">
                        <h3 className="text-xl md:text-3xl text-accent font-medium">Challenges & Solutions</h3>
                        <ul className="mt-4 md:mt-5">
                            {project.challengesRows.map((row) => (
                                <li key={row.challenge} className="border-b border-border py-3 md:py-4">
                                    <div className="flex flex-col gap-3 md:hidden">
                                        <div className="flex items-center gap-3"><p className="text-muted text-base">{row.challenge}</p><ArrowRight /></div>
                        ...
                        <div className="mt-8 md:mt-auto md:pt-8 flex flex-col md:flex-row items-end gap-6 md:gap-10">
                            <div className="relative w-[150px] h-[150px] md:w-[210px] md:h-[210px] shrink-0 overflow-hidden">
                                <Image src={project.challengesBottomImage} alt="Bathroom interior" fill sizes="210px" className="object-cover" />
                            </div>
                            <div className="flex-1">
                                <div className="w-full flex justify-between items-start gap-6 border-b border-border pb-1.5 md:pb-3">
                                    <p className="text-black text-sm md:text-base font-medium leading-snug">Ready to Create<br />Your Dream Space?</p>
                                    <MagneticButton><Button href="/about">Book a Consultant</Button></MagneticButton>
                                </div>
                            </div>
                        </div>
                    </div>
